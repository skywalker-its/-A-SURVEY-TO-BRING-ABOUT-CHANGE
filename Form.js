class Form {
    ...
    constructor() {
        ...
        this.question1 = createElement('h3', "Q1. Do You Think We Should Have 100 Canteens In our School ?");
        this.radio = createRadio('h3');
        this.radio.option('Correct');
        this.radio.option('Wrong');
        this.question2 = createElement('h3', "Q2. Would you be willing to contribute a small amount every week for such a program ?");
